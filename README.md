...
AkititoCraft is a free open-source voxel game with easy modding and game creation.

**Quick start (Windows):** double-click `AkititoCraft.bat` in this folder to launch the
game once it has been built (see [Compiling](#compiling)).
